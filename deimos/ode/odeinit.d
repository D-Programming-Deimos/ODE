 ...
 * @ingroup init
 */
enum uint dInitFlagManualThreadCleanup = 0x00000001; //@< Thread local data is to be cleared explicitly on @c dCleanupODEAllDataForThread function call
 ...
 * @ingroup init
 */
int dInitODE2(uint uiInitFlags/*=0*/);
...
enum : uint
{
    dAllocateFlagsBasicData = 0, //@< Allocate basic data required for library to operate

    dAllocateFlagsCollisionData = 0x00000001, //@< Allocate data for collision detection
