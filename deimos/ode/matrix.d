...
dReal dDot(in dReal* a, in dReal* b, int n);
...
void dMultiply0(dReal* A, in dReal* B, in dReal* C, int p, int q, int r);
void dMultiply1(dReal* A, in dReal* B, in dReal* C, int p, int q, int r);
void dMultiply2(dReal* A, in dReal* B, in dReal* C, int p, int q, int r);
...
void dSolveCholesky(in dReal* L, dReal* b, int n);
...
int dInvertPDMatrix(in dReal* A, dReal* Ainv, int n);
...
int dIsPositiveDefinite(in dReal* A, int n);
 ...
 */
void dSolveL1(in dReal* L, dReal* b, int n, int nskip);
 ...
 * the leading dimension of L is `nskip'.
 */
void dSolveL1T(in dReal* L, dReal* b, int n, int nskip);


/* in matlab syntax: a(1:n) = a(1:n) .* d(1:n) */

void dVectorScale(dReal* a, in dReal* d, int n);
...
void dSolveLDLT(in dReal* L, in dReal* d, dReal* b, int n, int nskip);
 ...
 */
void dLDLTAddTL(dReal* L, dReal* d, in dReal* a, int n, int nskip);
 ...
 */
void dLDLTRemove(
    dReal** A, in int *p, dReal* L, dReal* d, int n1, int n2, int r, int nskip
);
